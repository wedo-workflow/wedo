...
type TDefinitions struct {
	Import             []string `xml:"http://www.omg.org/spec/BPMN/20100524/MODEL import,omitempty"`
	BPMNDiagram        []string `xml:"http://www.omg.org/spec/BPMN/20100524/MODEL BPMNDiagram,omitempty"`
	Name               string   `xml:"name,attr,omitempty"`
	TargetNamespace    string   `xml:"targetNamespace,attr"`
	ExpressionLanguage string   `xml:"expressionLanguage,attr,omitempty"`
	TypeLanguage       string   `xml:"typeLanguage,attr,omitempty"`
	Exporter           string   `xml:"exporter,attr,omitempty"`
	ExporterVersion    string   `xml:"exporterVersion,attr,omitempty"`
}

func (t *TDefinitions) UnmarshalXML(d *xml.Decoder, start xml.StartElement) error {
	type T TDefinitions
	var overlay struct {
		*T
		ExpressionLanguage *string `xml:"expressionLanguage,attr,omitempty"`
	...
	overlay.T = (*T)(t)
	overlay.ExpressionLanguage = (*string)(&overlay.T.ExpressionLanguage)
	overlay.TypeLanguage = (*string)(&overlay.T.TypeLanguage)
